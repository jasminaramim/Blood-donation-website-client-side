        ...
        <div className="container mx-auto px-4 sm:px-8">
            ...
            <div className="py-8">
                ...
                <div className="flex justify-center mb-8">
                    <div className="bg-red-100 shadow-lg rounded-lg p-6 max-w-3xl w-full">
                        {/* Card Header */}
                            ...
                            >
                                ...
                                <div className="text-center p-6">
                                    ...
                                    <p className="text-gray-600 mt-3">
                                        <span className="text-red-600 font-bold">District:</span> {request.recipientDistrict}
                                    </p>
                                    <p className="text-gray-600 mt-3">
                                        <span className="text-red-600 font-bold">Upazila:</span> {request.recipientUpazila}
                                    </p>
                                    <p className="text-gray-600 mt-3">
                                        <span className="text-red-600 font-bold">Hospital:</span> {request.hospitalName}
                                    </p>
                                    <p className="text-gray-600 mt-3">
                                        <span className="text-red-600 font-bold">Address:</span> {request.fullAddress}
                                    </p>
                                    <p className="text-gray-600 mt-3">
                                        <span className="text-red-600 font-bold">Donation Date:</span> {new Date(request.donationDate).toLocaleDateString()}
                                    </p>
                                    <p className="text-gray-600 mt-3">
                                        <span className="text-red-600 font-bold">Donation Time:</span> {request.donationTime}
                                    </p>
                                    <p className="text-gray-600 mt-3">
                                        <span className="text-red-600 font-bold">Message:</span> {request.requestMessage}
                                    </p>
                                </div>
                ...
                {searchClicked && filteredRequests.length === 0 && (
                    <div className="mt-4 text-center">
                        <Lottie
                            ...
                            width={200}
                        />
                        <div className="mt-4 text-2xl font-bold text-center text-red-500">No donation requests found matching the criteria.</div>
                    </div>
                )}
